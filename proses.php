...
$pesan = mysqli_query($koneksi, "insert into pemesanan values ('$nik','$nama','$alamat','$instagram','$no_hp','$tanggal','$status','$perawatan','$harga','$diskon','$total')");

if ($pesan) {
    echo "<script> alert ('Data Berhasil Disimpan')</script>";
    header("refresh:0;tampilan.php?nik=" . $nik);
} else {
    echo "<script> alert ('Data Tidak Berhasil Disimpan')</script>";
    header("refresh:0;form_order.php");
}
?>