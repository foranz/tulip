<!doctype html>
  ...
  <div class="row no-glutters mt-5"> <!--navbar tdk ada jarak-->
    ...
    <div class="col-md-10 p-5 pt-3" style="padding-top: 500px">
      <h3 style="margin-top: 50px"><i class="fa fa-user-md"></i> List Treatment</h3><hr><hr>
      <div class="row">
        <!-- Area Chart -->
        <div class="col">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-danger">Treatment</h6>
              <a href="treatmenttambah.php" class="d-none d-sm-inline-block btn btn-danger btn-sm shadow-sm">
                <i class="fa fa-plus-circle" aria-hidden="true"></i>Tambah Treatment
              </a>
              </div>
              <!-- Card Body -->
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped table-sm" id="treatment" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th>No</th>
                    ...
                    <tbody>
                      ...
                      while($row=$treatment->fetch_object()){
                        ...
                        <tr>
                          ...
                          <td><center><img src ="<?php echo "asset/".$row->gambar ?>" width=250px></center></td>
                          <td>
                        <a href ="<?php echo "treatmentdelete.php?id=".$row->id ?>" class="btn btn-circle btn-sm btn-secondary">
