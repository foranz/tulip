<!DOCTYPE html>
  ...
  <div class="row no-glutters mt-5"> <!--navbar tdk ada jarak-->
    ...
    <div class="col-md-10 p-5 pt-5" style="padding-top: 1000px">
      <h3><i class="fa fa-book"></i>   List Pesanan</h3><hr><hr>
      <div class="row">
        <!-- Area Chart -->
        <div class="col">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              ...
              <a href="ordertambah.php" class="d-none d-sm-inline-block btn btn-danger btn-sm shadow-sm">
                <i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Pesanan</a>
              </div>
              <!-- Card Body -->
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped table-sm" id="pesanan" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      while($row=$pesanan->fetch_object()){
                        ?>
                        <tr>
                          ...
                          <td>
                        <a href ="<?php echo "orderdelete.php?nik=".$row->nik ?>" class="btn btn-circle btn-sm btn-secondary">
